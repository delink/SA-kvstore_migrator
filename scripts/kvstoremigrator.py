...
class kvstoremigrator(object):
	...
	def __init__(self,src_splunk_details,dest_splunk_details):
		...
		if 'session_key' in src_splunk_details:
			self.src_splunk = splunkkvstore(src_splunk_details['url'],src_splunk_details['session_key'])
		elif 'username' in src_splunk_details:
			self.src_splunk = splunkkvstore(src_splunk_details['url'],src_splunk_details['username'],src_splunk_details['password'])
		if 'session_key' in dest_splunk_details:
			self.dest_splunk = splunkkvstore(dest_splunk_details['url'],dest_splunk_details['session_key'])
		elif 'username' in dest_splunk_details:
